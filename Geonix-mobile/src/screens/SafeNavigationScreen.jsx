          ...
          <View style={styles.weatherCard}>
            ...
            <View style={styles.weatherRow}>
              <View style={styles.weatherItem}>
                <Text style={styles.weatherVal}>{result.weather.temperature.toFixed(1)}°C</Text>
              ...
              <View style={styles.weatherItem}>
                <Text style={styles.weatherVal}>{result.weather.rainfall.toFixed(1)} mm</Text>
                <Text style={styles.weatherLabel}>Rainfall</Text>
              </View>
              <View style={styles.weatherItem}>
                <Text style={styles.weatherVal}>{result.weather.wind_speed.toFixed(1)} km/h</Text>
